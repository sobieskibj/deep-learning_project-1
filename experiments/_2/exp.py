...
if __name__ == '__main__':
    ...
    for i, config in enumerate(configs):
        ...
        model = ConvNet(**config['model']).to(config['training']['device'])
        ...
        model_id = f'architecture:{arch}_seed:{seed_v}_n_augs:{n_augs}_lr:{lr_v}_bs:{batch_size_v}_l2:{l2_v}_dropout:{dropout_v}.pt'
